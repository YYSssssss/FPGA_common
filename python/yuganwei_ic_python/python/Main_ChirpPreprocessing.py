    ...
    for jth_RX in range(N_Rx_Channel):
        ...
        for mth_Chirp in range(N_chirps_per_frame):
            ...
            if  if_rfft == 0:
                ...
                read_txt.generate_result_data(data_comp, FFT_Hex_Output_txt, is_32, if_rfft);
...
if __name__ == '__main__':
    ...
    #input文件的地址
    #parser.add_argument('--input_txt', type=str, default="/prj/chips/pvg/venus/yuyushan/jade_venus_3/vobs/ip/rsp/verif/rsp_s1_prep/sim/run/tl_rsp_s1_prep_normal_rsp_s1_prep_test_0_0_861239/rsp_s1_op_mst_a_321.txt", help='Path of the input file')
    parser.add_argument('--input_txt', type=str, default="/home/users/yuyushan/work/rsp_s1_prep/rsp_s1_prep_sim/input_data/rsp_s1_op_mst_a_1.txt", help='Path of the input file')
    # output文件的地址
    ...
    # 是否处理的是实数
    parser.add_argument('--i_is_real', type=int, default=0,
                        help='Fill in 1 for real operation, and 0 for complex operation')

    # 是否处理的32位
    parser.add_argument('--i_is_32', type=int, default=1,
