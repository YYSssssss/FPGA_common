...
module design_0_v_demosaic_0_0_AXIvideo2MultiBayer_Pipeline_loop_wait_for_start (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] sof_fu_86_p1;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    s_axis_video_TDATA_blk_n;
reg   [0:0] axi_last_V_fu_42;
reg   [31:0] axi_data_V_fu_46;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((~((s_axis_video_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        axi_data_V_fu_46 <= s_axis_video_TDATA;
        axi_last_V_fu_42 <= s_axis_video_TLAST;
    end
end
...
always @ (*) begin
    if ((~((s_axis_video_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (sof_fu_86_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign axi_data_V_out = axi_data_V_fu_46;

assign axi_last_V_out = axi_last_V_fu_42;

assign sof_fu_86_p1 = s_axis_video_TUSER;

endmodule //design_0_v_demosaic_0_0_AXIvideo2MultiBayer_Pipeline_loop_wait_for_start
